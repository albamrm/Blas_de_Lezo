...
def main():
    ...
    while True:
        try:
            ...
            if 0 <= x < TAMANO_TABLERO and 0 <= y < TAMANO_TABLERO:
                tablero_maquina.disparo_coordenada(x, y, tablero_maquina.id_jugador)
            else:
            ...
            tablero_jugador.disparo_coordenada(x, y, tablero_jugador.id_jugador)# para que cumpla con peticion del argumento id_jugador
